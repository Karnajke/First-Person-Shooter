...
public class FPSInput : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float deltaZ = Input.GetAxis("Vertical") * speed; //"Horizontal" и "Vertical" — это дополнительные имена для сопоставления с клавиатурой.
        //transform.Translate(deltaX * Time.deltaTime, 0, deltaZ * Time.deltaTime); //Перемещение исипользуя трансформ
